...
function get_css_content(){
    ...
    // Footer CSS
    $content .= '#footer-usps{background-color:' . get_field($footer_usps['background_color']) . ';}';
    $content .= '#footer-widgets{background-color:' . get_field($footer_widgets['background_color']) . ';}';
    $content .= '#footer-copyright{background-color:' . get_field($footer_copyright['background_color']) . ';}';
